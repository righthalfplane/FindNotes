...
//c++ -std=c++11 -o splitter.x splitter.cpp -lGLEW `/opt/local/Library/Frameworks/wxWidgets.framework/Versions/wxWidgets/3.1/bin/wx-config --cxxflags --libs --gl-libs`

char* ProgramVersion = (char*)"Notes-077";
...
class MyCanvas2: public wxScrolledWindow
{
public:
    MyCanvas2(wxWindow* parent, bool mirror);
    virtual ~MyCanvas2(){}
...
private:
    ...
    wxDECLARE_NO_COPY_CLASS(MyCanvas2);
};
                 ...
                 wxDefaultPosition, wxSize(420, 300))
{
    ...
    m_right = new MyCanvas2(m_splitter, false);
...
/*
  	wxPanel *panel = new wxPanel(parent, -1, wxDefaultPosition, wxSize(500, 520), wxSIMPLE_BORDER | wxBORDER);
...
MyCanvas2::MyCanvas2(wxWindow* parent, bool mirror)
        : wxScrolledWindow(parent, wxID_ANY, wxDefaultPosition, wxDefaultSize,
                           wxHSCROLL | wxVSCROLL)
{
    m_mirror = mirror;
...
void MyCanvas2::OnDraw(wxDC& dcOrig)
{
    wxMirrorDC dc(dcOrig, m_mirror);
