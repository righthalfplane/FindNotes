...
void *eMalloc(unsigned long r,int tag)
{
    ...
    if(!ret)throw std::runtime_error("eMalloc Failed");;
...
int Poly::bilinear(double f)
{
    ...
    snprintf(mes,sizeof(mes),"bilinear Coefficients");
...
int Poly::warp(double f)
{
   double pi=4.0*atan(1.0);
    ...
    snprintf(mes,sizeof(mes),"Warped Coefficients  wd = %18.9e",wd);
...
int Poly::doChev(int np,double r)
{
    ...
    snprintf(mes,sizeof(mes),"Chebyshev Poles ripple = %18.9e db",r);
...
int Poly::high(double f,int inorm)
{
    ...
    snprintf(mes,sizeof(mes),"High Pass Transformation f = %18.9e",f);
...
int Poly::low(double f,int inorm)
{
    ...
    snprintf(mes,sizeof(mes),"Low Pass Transformation f = %18.9e",f);
...
int Poly::band(double f,int flag,double iter)
{
    ...
    snprintf(mes,sizeof(mes),"Band Transformation f = %18.9e",f);
